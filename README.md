...
<div align="center">
  <a href="https://github.com/King-sj/rust_template">
    <img src="[images/logo.png](https://bupt.online/logo.png)" alt="Logo" width="80" height="80">
  </a>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `King-sj`, `rust_template`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin King-sj/rust_template
